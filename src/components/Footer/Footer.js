...
const Footer = () => {
    return (
        <div className="bg-chat text-white shadow-2xl p-16">
        <div className="container px-4 mx-auto">
            <div className="grid xs:grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
                <div className="">
                    <h1 className="text-3xl font-bold text-purple-500  mb-5">B-Host</h1>
                    <p className="text-white">© 2021, All Rights Reserved.</p>
                    <h6 className="text-white">Design & Develop By</h6>
